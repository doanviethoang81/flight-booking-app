...
export default function FilterFlight() {
  ...
  const handleSubmit = async () => {
    if (isRoundTrip && new Date(departureDate) >= new Date(returnDate)) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto">
      <div className="flex flex-col items-center border-1  border-blue-600 rounded-md shadow-blue-100 shadow-2xl">
        <div className="bg-white p-6 rounded-lg shadow-md w-full grid grid-cols-3 gap-4">
          ...
          <div className="col-span-1 relative">
            <div className="font-semibold">Số hành khách</div>
            <TextField
            ...
            {passengersForm && (
              ...
              >
                ...
                <div className="mt-4 flex justify-end">
                  <button className="px-2 py-1 rounded text-blue-400 border-1 border-blue-500 hover:bg-blue-50 cursor-pointer"
          ...
          <div className="col-span-1 mt-5">
            <div className="font-semibold">Hạng ghế</div>
            <TextField
              select
              variant="standard"
              value={seatClass}
          ...
          <div className="col-span-1 text-right">
            <button className="px-2 py-1 rounded text-white bg-blue-500 cursor-pointer hover:opacity-90 w-full flex items-center justify-center"
      ...
      {loading ?
        <Box className="flex items-center justify-center mt-2 h-55">
          <Spin size="large" />
        </Box> :
